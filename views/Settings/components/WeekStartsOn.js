...
const WeekStartsOnSettings = ({ setSubPage }) => {
  return (
    <>
      <div
      ...
      <div className="mb-3 px-4">
        <h1 className="mb-2 font-bold text-neutral-700">Week starts on</h1>
      ...
      <div className="mb-2">
        <div className="mx-2 flex h-10 cursor-pointer items-center justify-between rounded-md p-2 hover:bg-neutral-100">
          <div className="flex items-center">
            <h3 className="text-sm font-medium  text-neutral-700">Sunday</h3>
          </div>
          <div className="flex items-center">
            <CheckCircleIcon
              className="h-5 w-5 text-neutral-700"
        ...
        <div className="mx-2 flex h-10 cursor-pointer items-center justify-between rounded-md p-2 hover:bg-neutral-100">
          <div className="flex items-center">
            <h3 className="text-sm font-medium  text-neutral-700">Monday</h3>
          </div>
        </div>
      </div>
    </>
...
export default WeekStartsOnSettings;
