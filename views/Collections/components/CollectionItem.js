...
const CollectionItem = ({ title, url, favicon, id, setDetailsId }) => {
  return (
    <div
      className="mx-2 mb-2 flex cursor-pointer items-center rounded-md p-2 last:mb-4 hover:bg-neutral-100"
